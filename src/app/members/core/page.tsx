...
import { Users, ShieldCheck, Linkedin, Github } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-20 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            ...
            <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed font-light">
              Meet the dedicated individuals who lead our club, drive our vision, and inspire creativity.
            </p>
          </div>
        </div>
      </div>
        ...
        {isLoading ? (
            <LoadingSkeletons />
             ...
             <div className="text-center py-12">
                ...
                <p className="text-gray-400">Core Team members for the selected session will be displayed here.</p>
            </div>
        )}
      </div>
    </div>
